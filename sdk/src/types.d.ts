...
export type { ContractEvent, ContractStats, GovernanceProposal, Invoice, InvoiceState, LPStats, ProposalStatus, ReputationScore, Token, } from "@iln/shared";
...
export interface RpcServerLike {
    ...
    pollTransaction(hash: string, options?: {
        attempts?: number;
    }): Promise<unknown>;
}
